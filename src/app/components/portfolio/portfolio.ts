...
export class PortfolioComponent {
  ...
  projects: Project[] = [
    { id: 'careerhub', name: 'CareerHub.AI',    description: 'AI-powered college & career readiness app with an AI coach, assessments, and planning tools across 800+ BLS occupations. Deployed to the App Store and Google Play.', tags: ['Ionic', 'Angular', 'Firebase', 'Azure', 'AI'],                  bgColor: '#0F172A', accentColor: '#F97316', url: 'https://getcareerhub.com/' },
